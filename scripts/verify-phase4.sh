...
if [ -f "scripts/manage-api-keys.sh" ]; then
    print_result "PASS" "scripts/manage-api-keys.sh exists"
    if [ -x "scripts/manage-api-keys.sh" ]; then
        print_result "PASS" "scripts/manage-api-keys.sh is executable"
    else
        print_result "FAIL" "scripts/manage-api-keys.sh is not executable"
    fi
else
    print_result "FAIL" "scripts/manage-api-keys.sh missing"
fi
...
if [ -f "scripts/manage-api-keys.sh" ]; then
    ...
    if grep -q "add_key\|add" scripts/manage-api-keys.sh; then
    ...
    if grep -q "remove_key\|remove" scripts/manage-api-keys.sh; then
    ...
    if grep -q "gcloud secrets" scripts/manage-api-keys.sh; then
