...
if check_file "scripts/setup-secrets.sh"; then
    check_executable "scripts/setup-secrets.sh"
    check_script_functionality "scripts/setup-secrets.sh" "create-all"
    check_script_functionality "scripts/setup-secrets.sh" "gcloud secrets"
fi

# Check setup-service-accounts.sh
if check_file "scripts/setup-service-accounts.sh"; then
    check_executable "scripts/setup-service-accounts.sh"
    check_script_functionality "scripts/setup-service-accounts.sh" "create-all"
    check_script_functionality "scripts/setup-service-accounts.sh" "gcloud iam"
fi
