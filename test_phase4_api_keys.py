...
def test_manage_api_keys_script_exists():
    ...
    assert os.path.exists("scripts/manage-api-keys.sh"), "manage-api-keys.sh not found"
    assert os.access("scripts/manage-api-keys.sh", os.X_OK), "manage-api-keys.sh not executable"
