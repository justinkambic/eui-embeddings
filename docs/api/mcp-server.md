...
python tests/integration/test_mcp_server.py --all
```
...
- `--svg-file <path>` - Test SVG search with a specific SVG file
  ```bash
  python tests/integration/test_mcp_server.py --svg-file path/to/test.svg
  ```
...
- `--svg-string <svg>` - Test SVG search with SVG content provided as a string
  ```bash
  python tests/integration/test_mcp_server.py --svg-string "<svg viewBox='0 0 16 16'><circle cx='8' cy='8' r='6'/></svg>"
  ```
...
- `--image-file <path>` - Test image search with a specific image file (PNG, JPG, etc.)
  ```bash
  python tests/integration/test_mcp_server.py --image-file path/to/test.png
  ```
...
- `--icon-type <type>` - Specify icon type: `icon` or `token` (affects default field selection)
  ```bash
  python tests/integration/test_mcp_server.py --icon-type token
  ```
...
- `--token-svg` - Include `token_svg_embedding` field in search (flag, no value needed)
  ...
  python tests/integration/test_mcp_server.py --icon-svg --token-svg --svg-string "<svg>...</svg>"
  
  # Search all four fields
  python tests/integration/test_mcp_server.py --icon-image --icon-svg --token-image --token-svg --image-file test.png
  ```
...
python tests/integration/test_mcp_server.py --svg-file path/to/test.svg
python tests/integration/test_mcp_server.py --svg-string "<svg>...</svg>"
python tests/integration/test_mcp_server.py --image-file path/to/test.png

# Combine multiple tests
python tests/integration/test_mcp_server.py --svg-file icon.svg --image-file screenshot.png

# Test only SVG with a specific file
python tests/integration/test_mcp_server.py --svg-file my-icon.svg

# Test only SVG with inline content
python tests/integration/test_mcp_server.py --svg-string "<svg viewBox='0 0 16 16'><circle cx='8' cy='8' r='6'/></svg>"

# Test with icon type specified (uses token fields by default)
python tests/integration/test_mcp_server.py --icon-type token --svg-file token.svg
...
python tests/integration/test_mcp_server.py --text "user icon"
python tests/integration/test_mcp_server.py --svg-file test.svg
python tests/integration/test_mcp_server.py --image-file test.png
```
...
3. **Test Image Search**
   ...
   python tests/integration/test_mcp_server.py --image-file screenshot.png
   ```
