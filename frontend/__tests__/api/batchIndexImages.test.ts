/**
 * Unit tests for pages/api/batchIndexImages.ts
 */
...
import handler from '../../pages/api/batchIndexImages'
...
describe('/api/batchIndexImages', () => {
  ...
  it('should batch index images successfully', async () => {
