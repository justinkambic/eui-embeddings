...
./scripts/setup/setup-service-accounts.sh create-all
```
...
./scripts/setup/setup-secrets.sh create-all
```
...
```bash
./scripts/setup/setup-secrets.sh list
```
...
```bash
./scripts/setup/setup-service-accounts.sh grant-secret-access
```
